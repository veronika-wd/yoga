        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input
                    ...
                    name="name"
                    id="name"
                    class="form-input has-icon {{ $errors->has('name') ? 'error' : '' }}"
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <button type="button" class="password-toggle" onclick="togglePassword()" aria-label="Показать пароль">
                    <svg id="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
